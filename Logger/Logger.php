...
class Logger
{
    ...
    public static  function writeLog($args = [])
    {
        ...
        error_log("{$timeLog}{$lineLog}: {$severityLog} - {$messageLog} {$contextLog}".PHP_EOL, 3, static::$log_file);
    ...
    public static function absToRelPath($pathToConvert)
    {
        ...
        return (isset($_SERVER['SERVER_NAME']) ? $_SERVER['SERVER_NAME'] : '') . str_replace($documentRoot, '', $pathAbs);
    }
